...
Public Class IniFile
    ...
    Public Function GetString(ByVal Section As String, ByVal Key As String, Optional ByVal DefaultValue As String = "") _
        As String

        Try
            ' Returns a string from your INI file
            Dim intCharCount As Int32
            'integer
            Dim objResult As New StringBuilder(256)
            Trace.WriteLine(" section= " & Section)
            Trace.WriteLine(" key = " & Key)
            Trace.WriteLine(" strfilename = " & strFilename)

            intCharCount = GetPrivateProfileString(Section, Key, _
                                                    DefaultValue, objResult, objResult.Capacity, strFilename)
            If intCharCount > 0 Then
                Return Left(objResult.ToString, intCharCount)
            End If

        Catch ex As Exception
            Trace.WriteLine("IniFile.GetString method failed... Error description: " & ex.Message)
        End Try
        Return ""
    End Function
