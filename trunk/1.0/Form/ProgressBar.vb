...
Public Class ProgressBar
    Private Sub ProgressBar_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
    ...
    Private Sub SetTextSave(ByVal [text] As String)
        ...
        If Me.ProgressBarLabel.InvokeRequired Then
            Dim a As New SetTextCallback(AddressOf SetTextSave)
            Me.Invoke(a, New Object() {lngProgressBarSaveLabel})
        Else
        ...
        If Me.InvokeRequired Then
            ...
            Me.Invoke(b, New Object() {lngProgressBarSaveTitre})
        Else
    ...
    Private Sub SetTextRestore(ByVal [text] As String)
        ...
        If Me.ProgressBarLabel.InvokeRequired Then
            ...
            Me.Invoke(c, New Object() {lngProgressBarRestoreLabel})
        Else
        ...
        If Me.InvokeRequired Then
            ...
            Me.Invoke(d, New Object() {lngProgressBarRestoreTitre})
        Else
