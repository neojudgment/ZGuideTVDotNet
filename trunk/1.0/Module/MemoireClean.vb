...
Friend Module MemoireClean
    ...
    Friend Sub Memoire_Clean()
        ...
        Console.WriteLine(DateTime.Now & " " & "Mémoire allouée à ZGuideTV.NET après nettoyage de la mémoire = octets " & _
