...
Public Class BarreTemporelle
    ...
    Public Property OldUi As Boolean
        ...
        Set(ByVal value As Boolean)
            _oldUi = value
            btJourmoins.old_UI = _oldUi
            btHeuremoins.old_UI = _oldUi
            bt06h.old_UI = _oldUi
            bt09h.old_UI = _oldUi
            bt12h.old_UI = _oldUi
            bt15h.old_UI = _oldUi
            ...
            bt20h.old_UI = _oldUi
            bt23h.old_UI = _oldUi
            btMaintenant.old_UI = _oldUi
            btHeureplus.old_UI = _oldUi
            btJourplus.old_UI = _oldUi
            RedrawBouton()
        End Set
    End Property
    ...
    Private Sub TestButtonChanged3(ByVal sender As Object, ByVal e As EventArgs) Handles btMaintenant.Click
        If _
            Not (DirectCast(sender, Control).Name.Equals(_memobouton, StringComparison.CurrentCulture)) OrElse _
            _memomaintenant <> DateTime.Now.Hour Then
            _memobouton = DirectCast(sender, Control).Name
