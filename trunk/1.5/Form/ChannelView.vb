        ...
        If Not (Not IdentifiantLogo Is Nothing AndAlso String.IsNullOrEmpty(IdentifiantLogo)) Then
            For i As Integer = 0 To cbo_Chaine.Items.Count
                If [String].Equals(_idChaine(i), IdentifiantLogo, StringComparison.CurrentCulture) Then
                    If _
                        [String].Equals(MomentSouhaite.ToString("yyyyMMdd", CultureInfo.CurrentCulture), DateTime.Now.AddHours(-DecalHoraire).ToString("yyyyMMdd", CultureInfo.CurrentCulture), StringComparison.CurrentCulture) Then
        ...
        If ChannelListView.SelectedItems.Count = 1 Then
            ...
            Try
                ...
                Else
                    ...
                    boxNoConnection = _
                        MessageBox.Show( _
                                         CentralScreen.MessageBoxNoConnection & Chr(13) & _
                                         CentralScreen.MessageBoxNoConnection1, _
                                         CentralScreen.MessageBoxNoConnectionTitre, _
            ...
            Catch ex As WebException
                ...
                boxNoConnection = _
                    MessageBox.Show( _
                                     CentralScreen.MessageBoxNoConnection & Chr(13) & _
                                     CentralScreen.MessageBoxNoConnection1, CentralScreen.MessageBoxNoConnectionTitre, _
                                     MessageBoxButtons.OK, _
                                     MessageBoxIcon.Exclamation)
            End Try
