...
#Region "MainformLoad"
    ...
    Private Sub MainformLoad(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
        ...
        SplashScreenClass.VersionText(fv.ProductName & " v" & fv.FileVersion & " beta Release")
        ...
        If ((_os.Version.Major = 6 AndAlso _os.Version.Minor >= 1) OrElse _os.Version.Major > 6) AndAlso
        ...
        If curVersion.CompareTo(newVersion) < 0 Then
            ...
            Try
                If My.Settings.AudioOn Then
                    ...
                    Dim data As New MemoryStream(xa)
                    wave.Init(
                        New BlockAlignReductionStream(WaveFormatConversionStream.CreatePcmStream(New WaveFileReader(data))))
                    wave.Volume = CInt(My.Settings.MessagesVolume/10)
                    wave.Play()
                End If
            Catch ex As Exception
...
#End Region
        ...
        Try
            ...
            Else
                For rowNumber = 0 To objetDataTable.Rows.Count - 1
                    ...
                    Else
                        imageListChannel.Images.Add(Image.FromFile(LogosPath & "vide.gif"))
    ...
    Private Sub VisualisationParHeureToolStripMenuItem_Click(sender As Object, e As EventArgs)
