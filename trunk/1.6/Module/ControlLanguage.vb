...
Friend Module ControlLanguage
    ...
    Public Sub SetControlLanguage(Optional ByVal iForm As Integer = 0)
        ...
        MiseAJourAuto.Error1Majauto = LngError1Majauto
        MiseAJourAuto.Error2Majauto = LngError2Majauto
        MiseAJourAuto.Error3Majauto = LngError3Majauto
        MiseAJourAuto.Error4Majauto = LngError4Majauto
        MiseAJourAuto.Error5Majauto = LngError5Majauto
        MiseAJourAuto.Error6Majauto = LngError6Majauto
        ...
        TriAvance.TriAvanceButtonCancel.Text = LngTriAvanceButtonCancel
