...
Namespace SQLiteWrapper
    ...
    Friend NotInheritable Class SafeNativeMethods
        ...
        Friend Shared Function sqlite3_open16(<MarshalAs(UnmanagedType.LPWStr)> ByVal dbname As String,
    ...
    Public Class SqLiteBase
        ...
        Private Function ReadFirstRow2TableauListEmissions(ByVal statement As IntPtr, ByRef tab() As EmissionsList) _
            As Integer
            Try
                ...
                If resultType = SqlRow Then
                    With tab(_i2)
                        ...
                        .Pcategory =
                            Marshal.PtrToStringUni(SafeNativeMethods.sqlite3_column_text16(statement, 7)).TrimEnd
