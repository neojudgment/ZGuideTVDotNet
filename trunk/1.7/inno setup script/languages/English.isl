...
WelcomeLabel2=This will install [name/ver] on your computer.%n%nZGuideTV.NET includes a new modern user interface, and more than 300 available channels.%n%n.NET Framework 4.5.2 is mandatory for ZGuideTV.NET to run.%n%nZGuideTV.NET is provided FREE OF CHARGE. If you paid for it (other than donate at the ZGuideTV.NET official website) then whe recommend that you get a refund!
