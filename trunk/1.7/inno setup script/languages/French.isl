...
WelcomeLabel2=Cet assistant va vous guider dans l'installation de [name/ver] sur votre ordinateur.%n%nZGuideTV.NET inclus une nouvelle interface utilisateur moderne, et plus de 300 chaînes disponibles.%n%nLe Framework .NET 4.5.2 est un composant obligatoire pour le fonctionnement de ZGuideTV.NET.%n%nZGuideTV.NET est fourni GRATUITEMENT. Si vous avez payé (autrement que par un don via le site officiel de ZGuideTV.NET), nous vous recommendons d'obtenir un remboursement!
