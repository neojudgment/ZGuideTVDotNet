...
' |                                                                                                            |
' |    Copyright (C) 2004-2026 ZGuideTV.NET Team <https://github.com/neojudgment>                              |
' |                                                                                                            |
...
<Serializable()> _
Partial Public Class AdvancedSearch_OnToday
...
#Region "IAdvancedSearchUI Members"
    ...
    Public Function GetSearchCriteria() As ISearchCriteria Implements IAdvancedSearchUI.GetSearchCriteria
        Dim isc As ISearchCriteria = New SearchCriteria_Date(DateTime.Now, SearchCriteria_Date.DateFields.StartTime, SearchCriteria_Date.DateConditions.Equals)
        Return (isc)
    End Function
