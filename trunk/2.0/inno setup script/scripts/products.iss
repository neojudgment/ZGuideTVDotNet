...
fr.depdownload_msg=Les applications suivantes sont nécessaires avant de pouvoir continuer l'installation du programme:%n%n%1%nTélécharger et installer maintenant ?

en.depdownload_memo_title=Download dependencies
fr.depdownload_memo_title=Téléchargement des dépendances

en.depinstall_memo_title=Install dependencies
fr.depinstall_memo_title=Installation des dépendances

en.depinstall_title=Installing dependencies
fr.depinstall_title=Installation des dépendances

en.depinstall_description=Please wait while Setup installs dependencies on your computer.
fr.depinstall_description=Veuillez patienter pendant que l'assistant d'installation installe les dépendances sur votre ordinateur.

en.depinstall_status=Installing %1...
fr.depinstall_status=Installation %1...

en.depinstall_missing=%1 must be installed before setup can continue. Please install %1 and run Setup again.
fr.depinstall_missing=%1 doit être installé avant que l'assistant d'installation ne puisse continuer. Installez %1 et redémarrez à nouveau l'assistant.

en.depinstall_error=An error occured while installing the dependencies. Please restart the computer and run the setup again or install the following dependencies manually:%n
fr.depinstall_error=Une erreur s'est produite lors de l'installation des dépendances. Veuillez redémarrer l'ordinateur et exécuter à nouveau l'assistant d'installation ou d'installez les dépendances suivantes manuellement:%n
